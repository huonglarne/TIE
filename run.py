...
from src.model import TIEConfig, TIE
from src.dataset import StrucDataset, PiecedDataset
from src.utils import read_examples, convert_examples_to_features, RawResult, RawTagResult,\
    write_tag_predictions, write_predictions_provided_tag
from src.utils_evaluate import EVAL_OPTS, main as evaluate_on_squad
